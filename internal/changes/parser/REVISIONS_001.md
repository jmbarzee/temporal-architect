...
**Parallelism:** Independent — no other revisions depend on this fix, though `internal/changes/orchestrator/CHANGES_001.md` Group 2 item D9 (deferred re-application of `workflow_execution_timeout`) is blocked by it.
